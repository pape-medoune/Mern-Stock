...
function Footer () {
    ...
    return (
        <footer className="text-gray-500 bg-white px-4 py-2 w-full mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                {/* <img src={Logo} className="w-32 sm:mx-auto rounded-full" /> */}
                <p className="md:text-2xl font-bold p-2">
                <span className="md:text-5xl text-blue-600">
                    SamaStock
                </span>
                ,
                </p>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0 sm:text-center">
                    &copy; 2023 SamaStock All rights reserved.
                </div>
